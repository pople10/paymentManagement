		...
		<div class="row" style="margin-top:20px">
			<div class="col-lg-12">
				<div class="card" style="padding:10px;">
					<table id="pending" class="table table-striped table-bordered w-100 dt-responsive nowrap">
						<thead>
							<tr>
								<th>ID</th>
								<th>Amount</th>
...
<script src="js/pending.js?r=<?php echo rand(0,1100000000000); ?>"></script>
