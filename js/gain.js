...
$("a[href='gain']").addClass("active");
function update(id)
{
	var data = $.ajax({url:"controller/gainController.php",type:"POST",data:{op:"findById",id:id},async:false}).responseText;
